...
public class SocialActivityGroupingCacheModel implements CacheModel<SocialActivityGrouping>,
	...
	public SocialActivityGrouping toEntityModel() {
		...
		if (socialActivityIds == null) {
			socialActivityGroupingImpl.setSocialActivityIds(StringPool.BLANK);
		}
		else {
			socialActivityGroupingImpl.setSocialActivityIds(socialActivityIds);
		}
	...
	public void readExternal(ObjectInput objectInput) throws IOException {
		...
		socialActivityIds = objectInput.readUTF();
	}
	...
	public void writeExternal(ObjectOutput objectOutput)
		...
		if (socialActivityIds == null) {
			...
			objectOutput.writeUTF(socialActivityIds);
		}
	}
	...
	public long classPK;
	public int type;
	public String socialActivityIds;
}